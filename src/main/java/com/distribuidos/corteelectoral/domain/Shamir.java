...
public final class Shamir {
    ...
    public static final class SecretShare {
    ...
    private SecretShare[] split(final BigInteger secret) {
    ...
    public static BigInteger combine(final SecretShare[] shares, final BigInteger primeNum) {
